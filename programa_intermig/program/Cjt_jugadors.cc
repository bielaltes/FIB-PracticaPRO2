...
void Cjt_jugadors::nou_jugador(bool first) {
    string nom;
    cin >> nom;
    if (not first) cout << " " << nom << endl;
...
void Cjt_jugadors::baixa_jugador() {
    string nom;
    cin >> nom;
    cout << " " << nom << endl;
...
void Cjt_jugadors::consultar_jugador() {
    string n;
    cin >> n;
    cout << " " << n << endl;
    map<string,Jugador>::iterator trobat = jugadors.find(n);
    if (trobat!=jugadors.end()) {
