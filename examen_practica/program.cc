...
int main() {
    ...
    while (comanda!= "fin") {
        ...
        else if (comanda == "resultados_torneo" or comanda == "rt") {
            string nom;
            cin >> nom;
            cout << " " << nom << endl;
            tornejos.consultar_torneig(nom);
        }
        ...
        else if (comanda == "mejor_jugador_sets" or comanda == "mjs") {
            jugadors.millor_jugador_sets();
        }
